...
var store = new _vuex.default.Store({
  ...
  actions: {
    ...
    set_history_list: function set_history_list(_ref2, history) {var commit = _ref2.commit,state = _ref2.state;
      var historyList = state.historyList;
      historyList.unshift(history);
      uni.setStorageSync('historyList', historyList);
      commit('SET_HISTORY_LIST', historyList);
    },
    clear_history_list: function clear_history_list(_ref3) {var commit = _ref3.commit;
...
var http = function http(name, data) {var isLoading = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  var newData = _objectSpread({ user_id: _index.default.state.userInfo._id }, data);
  if (isLoading) {
...
var _wxDiscode = _interopRequireDefault(__webpack_require__(/*! ./wxDiscode */ 177));
var _htmlparser = _interopRequireDefault(__webpack_require__(/*! ./htmlparser */ 178));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
